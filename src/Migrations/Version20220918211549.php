 ...
 */
final class Version20220918211549 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bitbag_mollie_subscription_configuration ADD subscription_id VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, ADD mandate_id VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`, DROP subscriptionId, DROP mandateId, CHANGE hostname host_name VARCHAR(255) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_unicode_ci`, CHANGE numberofrepetitions number_of_repetitions INT NOT NULL, CHANGE paymentdetailsconfiguration payment_details_configuration LONGTEXT CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8mb3_unicode_ci` COMMENT \'(DC2Type:array)\'');
        ...
        $this->addSql('ALTER TABLE sylius_product_variant ADD recurring TINYINT(1) DEFAULT \'0\' NOT NULL, ADD recurring_times INT DEFAULT NULL, ADD recurring_interval VARCHAR(255) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci`');
    }
}
